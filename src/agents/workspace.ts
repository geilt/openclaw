...
export const DEFAULT_GNAS_FILENAME = "GNAS.md";
...
export async function loadWorkspaceBootstrapFiles(dir: string): Promise<WorkspaceBootstrapFile[]> {
  ...
  const entries: Array<{
    ...
    {
      name: DEFAULT_GNAS_FILENAME,
      filePath: path.join(resolvedDir, DEFAULT_GNAS_FILENAME),
    },
  ];
...
const MINIMAL_BOOTSTRAP_ALLOWLIST = new Set([DEFAULT_AGENTS_FILENAME, DEFAULT_TOOLS_FILENAME, DEFAULT_GNAS_FILENAME]);
